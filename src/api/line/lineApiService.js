...
export const lineApiService = {
    getAllLines: async () => {
        try {
            ...
            throw new Error(error.response?.data?.detail || "Error al cargar las líneas");
        }
    },
    ...
    createLine: async (lineData) => {
        try {
            ...
            throw new Error(error.response?.data?.detail || "Error al crear la línea");
        }
    },
    ...
    updateLine: async (lineId, lineData) => {
        try {
            ...
            throw new Error(error.response?.data?.detail || "Error al actualizar la línea");
        }
    },
    ...
    deleteLine: async (lineId) => {
        try {
            ...
            throw new Error(error.response?.data?.detail || "Error al eliminar la línea");
        }
    }
};